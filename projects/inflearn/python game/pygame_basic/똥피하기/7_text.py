...
# 적(enemy) 캐릭터
enemy=pygame.image.load("C:/Users/sklee/Desktop/모바일/인프런/파이썬 게임만들기/pygame_basic/enemy.png")
...
while running:
    ...
    #충돌 체크
    if character_rect.colliderect(enemy_rect): #.colliderect(enemy_rect)로 인해 캐릭터와 적이 충돌했는지 알수있음
        print("enemy와 충돌했습니다.")
        print("Game Over")
        running=False
    ...
    timer=game_font.render("Time: "+str(int(total_time-elapsed_time)),True,(255,255,255)) # 출력할 글자,True,글자생상
    ...
    if total_time-elapsed_time <=0:
        pygame.time.delay(2000) # 2초정도 딜레이 후에 게임 종료
        print("타임아웃")
        running= False
