...
public class ScannerWhileEx4 {//상품 구매
    /*
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (num == 1) {
                ...
                String priceName = input.nextLine();

                System.out.print("상품의 가격을 입력하세요: ");
                int price = input.nextInt();

                System.out.print("구매 수량을 입력하세요: ");
                int priceQuantity = input.nextInt();

                System.out.println("상품명:" + priceName + " 가격:" + price + " 합계:" + price * priceQuantity);

                totalCost += price * priceQuantity;
                ...
                System.out.println("옵션값 오류 다시 입력해주세요.");
            }
        }
    }
}
